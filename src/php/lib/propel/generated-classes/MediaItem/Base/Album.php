...
abstract class Album implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\MediaItem\\Map\\AlbumTableMap';
    ...
    /**
     * The value for the explicit field.
     * @var        boolean
     */
    protected $explicit;
    ...
    /**
     * Initializes internal state of MediaItem\Base\Album object.
     */
     ...
     *
     * @return Album The current object, for fluid interface
     */
     ...
     * @return   \MediaItem\Album The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AlbumTableMap::ID] = true;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[AlbumTableMap::TITLE] = true;
        }
    ...
    public function setScore($v)
    {
        ...
        if ($this->score !== $v) {
            $this->score = $v;
            $this->modifiedColumns[AlbumTableMap::SCORE] = true;
        }
    ...
    public function setReleaseDate($v)
    {
        ...
        if ($this->release_date !== $v) {
            $this->release_date = $v;
            $this->modifiedColumns[AlbumTableMap::RELEASE_DATE] = true;
        }
    ...
    /**
     * Set the value of [songs] column.
     *
     * @param      string $v new value
     * @return   \MediaItem\Album The current object (for fluent API support)
     */
    public function setSongs($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->songs !== $v) {
            $this->songs = $v;
            $this->modifiedColumns[AlbumTableMap::SONGS] = true;
        }
    ...
    public function setArtistId($v)
    {
        ...
        if ($this->artist_id !== $v) {
            $this->artist_id = $v;
            $this->modifiedColumns[AlbumTableMap::ARTIST_ID] = true;
        }
    ...
    public function setLabelId($v)
    {
        ...
        if ($this->label_id !== $v) {
            $this->label_id = $v;
            $this->modifiedColumns[AlbumTableMap::LABEL_ID] = true;
        }
    ...
    /**
     * Sets the value of the [explicit] column.
    ...
    public function setExplicit($v)
    {
        ...
        if ($this->explicit !== $v) {
            $this->explicit = $v;
            $this->modifiedColumns[AlbumTableMap::EXPLICIT] = true;
        }
    ...
    public function setCover($v)
    {
        ...
        if ($this->cover !== $v) {
            $this->cover = $v;
            $this->modifiedColumns[AlbumTableMap::COVER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AlbumTableMap::translateFieldName('Score', TableMap::TYPE_PHPNAME, $indexType)];
            $this->score = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AlbumTableMap::translateFieldName('ReleaseDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->release_date = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AlbumTableMap::translateFieldName('Songs', TableMap::TYPE_PHPNAME, $indexType)];
            $this->songs = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AlbumTableMap::translateFieldName('ArtistId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artist_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AlbumTableMap::translateFieldName('LabelId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->label_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : AlbumTableMap::translateFieldName('Explicit', TableMap::TYPE_PHPNAME, $indexType)];
            $this->explicit = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : AlbumTableMap::translateFieldName('Cover', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 9; // 9 = AlbumTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \MediaItem\Album object", 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AlbumTableMap::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(AlbumTableMap::TITLE)) {
            $modifiedColumns[':p' . $index++]  = 'TITLE';
        }
        if ($this->isColumnModified(AlbumTableMap::SCORE)) {
            $modifiedColumns[':p' . $index++]  = 'SCORE';
        }
        if ($this->isColumnModified(AlbumTableMap::RELEASE_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'RELEASE_DATE';
        }
        if ($this->isColumnModified(AlbumTableMap::SONGS)) {
            $modifiedColumns[':p' . $index++]  = 'SONGS';
        }
        if ($this->isColumnModified(AlbumTableMap::ARTIST_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ARTIST_ID';
        }
        if ($this->isColumnModified(AlbumTableMap::LABEL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'LABEL_ID';
        }
        if ($this->isColumnModified(AlbumTableMap::EXPLICIT)) {
            $modifiedColumns[':p' . $index++]  = 'EXPLICIT';
        }
        if ($this->isColumnModified(AlbumTableMap::COVER)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'RELEASE_DATE':
                        ...
                        break;
                    case 'SONGS':
                        $stmt->bindValue($identifier, $this->songs, PDO::PARAM_STR);
                        break;
                    case 'ARTIST_ID':
                    ...
                    case 'LABEL_ID':
                        ...
                        break;
                    case 'EXPLICIT':
                        $stmt->bindValue($identifier, (int) $this->explicit, PDO::PARAM_INT);
                        break;
                    case 'COVER':
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[4] => $this->getSongs(),
            $keys[5] => $this->getArtistId(),
            $keys[6] => $this->getLabelId(),
            $keys[7] => $this->getExplicit(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setSongs($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setArtistId($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setLabelId($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setExplicit($arr[$keys[7]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AlbumTableMap::ID)) $criteria->add(AlbumTableMap::ID, $this->id);
        if ($this->isColumnModified(AlbumTableMap::TITLE)) $criteria->add(AlbumTableMap::TITLE, $this->title);
        if ($this->isColumnModified(AlbumTableMap::SCORE)) $criteria->add(AlbumTableMap::SCORE, $this->score);
        if ($this->isColumnModified(AlbumTableMap::RELEASE_DATE)) $criteria->add(AlbumTableMap::RELEASE_DATE, $this->release_date);
        if ($this->isColumnModified(AlbumTableMap::SONGS)) $criteria->add(AlbumTableMap::SONGS, $this->songs);
        if ($this->isColumnModified(AlbumTableMap::ARTIST_ID)) $criteria->add(AlbumTableMap::ARTIST_ID, $this->artist_id);
        if ($this->isColumnModified(AlbumTableMap::LABEL_ID)) $criteria->add(AlbumTableMap::LABEL_ID, $this->label_id);
        if ($this->isColumnModified(AlbumTableMap::EXPLICIT)) $criteria->add(AlbumTableMap::EXPLICIT, $this->explicit);
        if ($this->isColumnModified(AlbumTableMap::COVER)) $criteria->add(AlbumTableMap::COVER, $this->cover);
    ...
    {
        $criteria = new Criteria(AlbumTableMap::DATABASE_NAME);
        $criteria->add(AlbumTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MediaItem\Album (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \MediaItem\Album Clone of current object.
     * @throws PropelException
     */
    ...
    public function getLabel(ConnectionInterface $con = null)
    {
        if ($this->aLabel === null && ($this->label_id !== null)) {
            $this->aLabel = LabelQuery::create()->findPk($this->label_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aLabel->addAlbums($this);
             */
        }
