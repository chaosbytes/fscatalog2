...
class BookTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'MediaItem.Map.BookTableMap';
     ...
     */
    const OM_CLASS = '\\MediaItem\\Book';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'MediaItem.Book';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Title', 'Year', 'Isbn', 'Cover', 'PublisherId', 'AuthorId', ),
        self::TYPE_STUDLYPHPNAME => array('id', 'title', 'year', 'isbn', 'cover', 'publisherId', 'authorId', ),
        self::TYPE_COLNAME       => array(BookTableMap::ID, BookTableMap::TITLE, BookTableMap::YEAR, BookTableMap::ISBN, BookTableMap::COVER, BookTableMap::PUBLISHER_ID, BookTableMap::AUTHOR_ID, ),
        self::TYPE_RAW_COLNAME   => array('ID', 'TITLE', 'YEAR', 'ISBN', 'COVER', 'PUBLISHER_ID', 'AUTHOR_ID', ),
        self::TYPE_FIELDNAME     => array('id', 'title', 'year', 'isbn', 'cover', 'publisher_id', 'author_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Title' => 1, 'Year' => 2, 'Isbn' => 3, 'Cover' => 4, 'PublisherId' => 5, 'AuthorId' => 6, ),
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'title' => 1, 'year' => 2, 'isbn' => 3, 'cover' => 4, 'publisherId' => 5, 'authorId' => 6, ),
        self::TYPE_COLNAME       => array(BookTableMap::ID => 0, BookTableMap::TITLE => 1, BookTableMap::YEAR => 2, BookTableMap::ISBN => 3, BookTableMap::COVER => 4, BookTableMap::PUBLISHER_ID => 5, BookTableMap::AUTHOR_ID => 6, ),
        self::TYPE_RAW_COLNAME   => array('ID' => 0, 'TITLE' => 1, 'YEAR' => 2, 'ISBN' => 3, 'COVER' => 4, 'PUBLISHER_ID' => 5, 'AUTHOR_ID' => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'title' => 1, 'year' => 2, 'isbn' => 3, 'cover' => 4, 'publisher_id' => 5, 'author_id' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\MediaItem\\Book');
    ...
    {
        $this->addRelation('Publisher', '\\MediaProperty\\Publisher', RelationMap::MANY_TO_ONE, array('publisher_id' => 'id', ), null, null);
        $this->addRelation('Author', '\\MediaProperty\\Author', RelationMap::MANY_TO_ONE, array('author_id' => 'id', ), null, null);
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(BookTableMap::YEAR);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \MediaItem\Book) { // it's a model object
