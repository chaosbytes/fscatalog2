...
class PublisherTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'MediaProperty.Map.PublisherTableMap';
     ...
     */
    const OM_CLASS = '\\MediaProperty\\Publisher';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'MediaProperty.Publisher';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\MediaProperty\\Publisher');
    ...
    {
        $this->addRelation('Book', '\\MediaItem\\Book', RelationMap::ONE_TO_MANY, array('id' => 'publisher_id', ), null, null, 'Books');
    } // buildRelations()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \MediaProperty\Publisher) { // it's a model object
