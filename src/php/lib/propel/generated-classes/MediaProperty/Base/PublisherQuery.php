...
use MediaProperty\PublisherQuery as ChildPublisherQuery;
use MediaProperty\Map\PublisherTableMap;
...
abstract class PublisherQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \MediaProperty\Base\PublisherQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'fscatalog2', $modelName = '\\MediaProperty\\Publisher', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \MediaProperty\PublisherQuery) {
            return $criteria;
        }
        $query = new \MediaProperty\PublisherQuery();
        if (null !== $modelAlias) {
