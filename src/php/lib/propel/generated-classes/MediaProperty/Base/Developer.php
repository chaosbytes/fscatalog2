...
abstract class Developer implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\MediaProperty\\Map\\DeveloperTableMap';
    ...
    /**
     * Initializes internal state of MediaProperty\Base\Developer object.
     */
    ...
    /**
     * Compares this with another <code>Developer</code> instance.  If
     * <code>obj</code> is an instance of <code>Developer</code>, delegates to
     * <code>equals(Developer)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return Developer The current object, for fluid interface
     */
     ...
     * @return   \MediaProperty\Developer The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[DeveloperTableMap::ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[DeveloperTableMap::NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : DeveloperTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : DeveloperTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = DeveloperTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \MediaProperty\Developer object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildDeveloperQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Developer::setDeleted()
     * @see Developer::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildDeveloperQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DeveloperTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[DeveloperTableMap::ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . DeveloperTableMap::ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(DeveloperTableMap::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(DeveloperTableMap::NAME)) {
            $modifiedColumns[':p' . $index++]  = 'NAME';
        }

        $sql = sprintf(
            'INSERT INTO developer (%s) VALUES (%s)',
    ...
    {
        $pos = DeveloperTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Developer'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Developer'][$this->getPrimaryKey()] = true;
        $keys = DeveloperTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        );
    ...
    {
        $criteria = new Criteria(DeveloperTableMap::DATABASE_NAME);

        if ($this->isColumnModified(DeveloperTableMap::ID)) $criteria->add(DeveloperTableMap::ID, $this->id);
        if ($this->isColumnModified(DeveloperTableMap::NAME)) $criteria->add(DeveloperTableMap::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(DeveloperTableMap::DATABASE_NAME);
        $criteria->add(DeveloperTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MediaProperty\Developer (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \MediaProperty\Developer Clone of current object.
     * @throws PropelException
     */
    ...
    public function initGames($overrideExisting = true)
    {
        ...
        $this->collGames->setModel('\MediaItem\Game');
    }
     ...
     * If this ChildDeveloper is new, it will return
     * an empty collection or the current collection; the criteria is ignored on a new object.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     * @return Collection|ChildGame[] List of ChildGame objects
     * @throws PropelException
     */
    public function getGames($criteria = null, ConnectionInterface $con = null)
    {
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return   ChildDeveloper The current object (for fluent API support)
     */
    ...
    {
        return (string) $this->exportTo(DeveloperTableMap::DEFAULT_STRING_FORMAT);
    }
