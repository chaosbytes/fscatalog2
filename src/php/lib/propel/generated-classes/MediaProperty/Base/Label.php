...
abstract class Label implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\MediaProperty\\Map\\LabelTableMap';
    ...
    /**
     * Initializes internal state of MediaProperty\Base\Label object.
     */
     ...
     *
     * @return Label The current object, for fluid interface
     */
     ...
     * @return   \MediaProperty\Label The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[LabelTableMap::ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[LabelTableMap::NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : LabelTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = LabelTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \MediaProperty\Label object", 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->artistsScheduledForDeletion !== null) {
                if (!$this->artistsScheduledForDeletion->isEmpty()) {
                    \MediaProperty\ArtistQuery::create()
                        ->filterByPrimaryKeys($this->artistsScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[LabelTableMap::ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . LabelTableMap::ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(LabelTableMap::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(LabelTableMap::NAME)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->collArtists) {
                $result['Artists'] = $this->collArtists->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LabelTableMap::ID)) $criteria->add(LabelTableMap::ID, $this->id);
        if ($this->isColumnModified(LabelTableMap::NAME)) $criteria->add(LabelTableMap::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(LabelTableMap::DATABASE_NAME);
        $criteria->add(LabelTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MediaProperty\Label (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \MediaProperty\Label Clone of current object.
     * @throws PropelException
     */
    ...
    public function initArtists($overrideExisting = true)
    {
        ...
        $this->collArtists->setModel('\MediaProperty\Artist');
    }
     ...
     * If this ChildLabel is new, it will return
     * an empty collection or the current collection; the criteria is ignored on a new object.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     * @return Collection|ChildArtist[] List of ChildArtist objects
     * @throws PropelException
     */
    public function getArtists($criteria = null, ConnectionInterface $con = null)
    {
    ...
    /**
     * Sets a collection of Artist objects related by a one-to-many relationship
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return   ChildLabel The current object (for fluent API support)
     */
    ...
    public function addArtist(ChildArtist $l)
    {
        ...
        if (!in_array($l, $this->collArtists->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            $this->doAddArtist($l);
        }
    ...
    /**
     * @param Artist $artist The artist object to add.
     */
    protected function doAddArtist($artist)
    {
    ...
    /**
     * @param  Artist $artist The artist object to remove.
     * @return ChildLabel The current object (for fluent API support)
     */
    public function removeArtist($artist)
    {
        if ($this->getArtists()->contains($artist)) {
            ...
            $this->artistsScheduledForDeletion[]= clone $artist;
     ...
     * Otherwise if this Label is new, it will return
     * an empty collection; or if this Label has previously
     * been saved, it will retrieve related Albums from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Label.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return Collection|ChildAlbum[] List of ChildAlbum objects
     */
    public function getAlbumsJoinArtist($criteria = null, $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = AlbumQuery::create(null, $criteria);
