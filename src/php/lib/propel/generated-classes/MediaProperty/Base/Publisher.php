...
abstract class Publisher implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\MediaProperty\\Map\\PublisherTableMap';
    ...
    /**
     * Initializes internal state of MediaProperty\Base\Publisher object.
     */
     ...
     * @return   \MediaProperty\Publisher The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[PublisherTableMap::ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[PublisherTableMap::NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException("Error populating \MediaProperty\Publisher object", 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MediaProperty\Publisher (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \MediaProperty\Publisher Clone of current object.
     * @throws PropelException
     */
